...
The gold standard for data on the semantic web is 5-star Linked Open Data\ac{lod}.
All resources (subjects, predicates, and objects) 
are named with \ac{https} \acp{uri} that can be looked-up on the web
to provide useful information with the Resource Description Framework\ac{rdf} family of standards.
...
Dr. Daryl Hepting\footnote{my supervisor} collects feedback from students in his classes each semester and makes the responses available on his 
website\footnote{\tt http://www2.cs.uregina.ca/$\sim$hepting/teaching/evaluation.html}. 
Hepting's feedback instrument~\cite{prof.} (as shown in Figure~\ref{feedback-form})
has 9 Likert items measured on a 5-point Likert 
...
response data? 
After a thorough search for Likert scales and items 
in the vocabulary repositories~\cite{cox2021ten} like 
...
Zenoda\footnote{\tt https://zenodo.org}, 
...
To do this, it is important to have a clear idea 
of the data model and the relationships among the data.
