...
when the information stored in the web of data, 
using \ac{rdf},
...
Hepting's feedback 
instrument\footnote{\tt http://www2.cs.uregina.ca/$\sim$hepting/assets/teaching/pdf/feedback-instrument.pdf} (as shown in Figure~\ref{feedback-form} on page~\pageref{feedback-form})
...
in the vocabulary repositories~\cite{cox2021ten} such as 
...
A preliminary vocabulary to capture the required semantics has been developed and
it is used to represent the feedback response data. 
