...
A query\footnote{https://en.wikipedia.org/wiki/SPARQL}  is used to retrieve information from a database that consists of multiple tables. 
%\marginpar{perhaps better to use SPARQL as reference for a query?-done}
