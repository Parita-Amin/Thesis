...
\say{global hypertext system} at the \ac{cern}. 
...
The original 
\say{web of documents} is becoming the 
\say{web of data} or the
\say{semantic web}. 
...
linked data is 
\say{a set of best practices for publishing and connecting structured data on the web}. 
...
Berners-Lee also contributed to web engineering by introducing a 5-star rating\footnote{https://www.w3.org/2011/gld/wiki/5\_Star\_Linked\_Data} 
system for the rating of linked data implementations. 
In this system, 
...
\say{used to retrieve information from the web of data} 
