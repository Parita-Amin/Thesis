...
\section{OWL Ontology for Feedback Survey Using Protégé}
...
\subsection{Classes for Feedback Survey Ontology}
...
\subsection{Object Properties for Feedback Survey Ontology}
...
\subsection{Data Properties for Feedback Survey Ontology}

 Figure~\ref{survey-data-properties} shows the data properties described for the survey ontology. 
...
\subsection{Final Class Hierarchy for Feedback Survey Ontology}
...
\subsection{Querying Feedback Survey Ontology in Protégé}
...
\subsection{Using OpenRefine for Feedback Survey Ontology}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=15cm]{images/ch4/survey-rdf-preview.png}
    \caption{RDF Preview for CSV using Survey Ontology}
    \label{survey-rdf-preview}
\end{figure}

\subsection{Using RMLStreamer for Feedback Survey Ontology}



\section{Publishing Vocabulary for Feedback Survey}
