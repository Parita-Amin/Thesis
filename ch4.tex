...
\section{Modeling OWL Ontology for Survey Using Protégé}
...
Protégé offers plugins to express \ac{sparql} as \say{\ac{sparql} Query} and \say{Snap \ac{sparql} Query}.
...
\section{Announcing Linked Data on the Web}

\subsection{Licensing Survey Vocabulary}



\subsection{Publishing Linked Open Vocabulary for Survey}
