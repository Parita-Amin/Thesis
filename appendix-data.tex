...
\UseRawInputEncoding
\chapter{SHACL Shapes for Data Validation: SurveyShapes.txt}\label{chap:appendix2}

<<<<<<< Updated upstream:appendix2.tex
%\begin{doublespace}
\lstset{ 
...
=======
\chapter{Expression of Survey Data in RDF}
\label{chap:appendix-data}
>>>>>>> Stashed changes:appendix-data.tex
