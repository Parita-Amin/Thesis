...
\noindent
Consider the \ac{uri} in Example~\ref{example-uri}.
...
\end{figure}
    ...
    \begin{figure}[htp]
        ...
        \caption{An illustration of Example~\ref{caloricontent} as an \ac{rdf} triple.
...
%??? what are first and second notations ???
...
\begin{flalign}  
    \text{\tt Pizza was enjoyed by William Shakespeare} &&
\end{flalign}
