...
\end{figure}
\noindent
One of the \acp{uri} from the Survey ontology is in Statement~\ref{example-uri}.
...
The University of Manchester has developed Pizza ontology~\cite{debellis2021practical}  
...
Data on a page of the Wikidata is available 
...
\begin{figure}[htp]
    ...
    \caption{A portion of the item page for {\tt University of Regina} on Wikidata.}
    \label{wikidata-uofr}
\end{figure}
...
Protégé also has a well-established tutorial~\cite{debellis2021practical} explaining its use.
...
The \ac{rml} rules can be written and tested in YARRRML (a more accessible way to use RML)
