...
??? see comments here in source file ???
...
\begin{figure}[htp]
    ...
    \caption{A portion of the item page for the University of Regina on Wikidata.}
    \label{wikidata-uofr}
\end{figure}
...
??? are these identifiers URIs, etc? ???
...
\begin{table}[h!]
	...
	\end{tabular}
    \caption{Identifier Properties and Property IDs for the University of Regina on Wikidata.}
...
??? how did you generate this? Is it better done in a tabbing environment? ???
...
Jimmy Wales and Larry Sanger in 2001 created 
Wikipedia\footnote{\tt https://en.wikipedia.org/wiki/Main\_Page},
what has become the largest general reference work on the internet.
It consists of articles in over 280 languages
that include data comprising templates, images, videos, categorizations, and links.
It acts as a source of data for many web projects like DBpedia, 
...
DBpedia enables querying of Wikipedia data 
as well as 
the generation of links amongst its structured datasets.
The result is a massive web of data.
...
DBpedia in 2007 ??? why a quote from 2007 ???
??? do you need all these footnotes? ???
...
shows the DBpedia entry for the University of Regina.
Like Wikidata, 
...
\begin{figure}[htp]
    ...
    \caption{Description of the University of Regina on DBpedia.}
    \label{dbpedia-uofr}
\end{figure}
