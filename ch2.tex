...
The University of Manchester developed the Pizza 
ontology~\cite{horridge2011practical,debellis2021practical}  
...
The relationships of the blank node with other nodes give sufficient details 
...
Azogu and Longo\cite{open2022} say that ``data and information that is ... electronically available in a 
...
Berners-Lee~\cite{soliddemo2016,solidtutorial2016} 
proposed a protocol called SOcial LInked Data (SOLID)
...
\begin{table}[h!]
		...
		\caption{Statement Properties and Property IDs for {\tt University of Regina} on Wikidata.\label{uofr-statement-properties-and-id}}
...
\begin{table}[h!]
	...
	\caption{Identifier Properties and Property IDs for {\tt University of Regina} on Wikidata.}
...
Benkler~\cite{benkler}\marginpar{see EE's note on page 21}
