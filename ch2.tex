...
%; and including links to other \ac{uri}s to discover more things.
...
??? the stuff about queries seems out of place???
...
%??? instead of wikipedia (yuck), how about\footnote{\tt https://www.w3.org/TR/sparql11-overview/}???
%
...
for the operating systems on \acp{uri}i}s, 
some specific protocols are defined depending on the 
UriScheme\footnote{\tt https://www.iana.org/assignments/uri-schemes/uri-schemes.xhtml}. 
...
\ac{uri} reference.
%\footnote{https://lists.w3.org/Archives/Public/uri/2007Jul/0027.html}.
...
\section{Usability Considerations} (google search for "Linked Open Usable Data")
\end{doublespace}