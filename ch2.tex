...
The idea of the Web, as described by Berners-Lee et al.~\cite{bernersreadings},
came from the positive experience of a small \say{home-brew} personal hypertext system.
%This \say{home-brew} system was used to keep track of personal information on a distributed project. 
\marginpar{this sentence is not clear}The Web can be used independently for multiple projects that can be later integrated with unique relationships among them using the newly shaped information to represent the new state of linked knowledge.
