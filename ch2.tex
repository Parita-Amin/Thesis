...
\begin{figure}[h]
	\framebox{\vbox{\tt\scriptsize
      ...
      \caption{Statement~\ref{caloriccontent} expressed as \ac{rdf}/\ac{xml}. The first few lines 
...
\begin{table}[h!]
        ...
        \end{tabular}
        \caption{Statement Properties and Property IDs for {\tt University of Regina} on Wikidata.}
...
``Subclasses specialize (``are subsumed by'') their super-classes''~\cite{horridge2009practical}. 
For instance, 
...
Protégé~\cite{protege} is the most popular amongst researchers.
...
Many scientists store and publish data using \ac{csv}, rather than \ac{rdf},
...
%
%\subsection{Open-Source Tools to Describe CSV Data using Vocabulary}
%\label{subsec:tools}
%
...
%
%??? These blurbs, below, seem quite close to wiki entries... please be careful...
%and please avoid the list format... I will fix this :-) ???
...
%After an extensive research on these tools, 
%OpenRefine has been used in this thesis as most of these tools are out-dated.
%Also, the community of data scientists is more interested in 
%developing more stable methods like using RMLConversion to map CSV data.
...
%\label{sec:summary}
%
%This Section provides a summary of my experience with different tools 
%at various stages of linked data development. 
%
%Initially, the idea was to follow the linked data life cycle but 
...
%has gaps and does not aid the development of all 5-star \acp{lod}. 
...
%
%The lack of advancement in related research resulted in 
%additional research on various ontology editors and mapping tools. 
%Most of the editors listed in Section~\ref{subsec:tools} 
%are either non-existent or there exists negligible information about them, 
%which has driven the decision of the use of protégé 
%for ontology development for this research. 
%Using RMLConversion is an interesting approach, 
%where the tools were studied 
%but the lack of standard guidelines forced the use of OpenRefine
%over RMLConversion tools. 

The building blocks discussed here are used
to define a generic process for publishing \ac{lod} from spreadsheet data (Chapter 3),
