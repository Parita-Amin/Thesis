...
%    \end{tabbing}
%    }}
%    \caption{An illustration of Statement~\ref{caloriccontent} as an \ac{rdf} triple.}
%    
%\end{figure}
...
%being the third entity acts as a connector between them. 
...
Protégé also has a well-established tutorial~\cite{pizzatutorial} explaining its use.
...
a procedure that follows the life cycle 
to ensure the quality of data to be published as linked data. ??? Unclear ???
The first stage
%, generally, 
...
\begin{table}[h!]
    \centering
    \begin{tabular}{|l|p{10cm}|} \hline 
     {\bf Stage} & {\bf Description} \\ \hline \hline
